...
export default function EBook() {
  ...
  const pageImage = [
    "http://wcfresource.a1edu.com/newsystem/image/br/eb/2a-002/eb-2a-002-1.jpg",
    "http://wcfresource.a1edu.com/newsystem/image/br/eb/2a-002/eb-2a-002-2.jpg",
    "http://wcfresource.a1edu.com/newsystem/image/br/eb/2a-002/eb-2a-002-3.jpg",
    "http://wcfresource.a1edu.com/newsystem/image/br/eb/2a-002/eb-2a-002-4.jpg",
    "http://wcfresource.a1edu.com/newsystem/image/br/eb/2a-002/eb-2a-002-5.jpg",
    "http://wcfresource.a1edu.com/newsystem/image/br/eb/2a-002/eb-2a-002-6.jpg",
    "http://wcfresource.a1edu.com/newsystem/image/br/eb/2a-002/eb-2a-002-7.jpg",
    "http://wcfresource.a1edu.com/newsystem/image/br/eb/2a-002/eb-2a-002-8.jpg",
    "http://wcfresource.a1edu.com/newsystem/image/br/eb/2a-002/eb-2a-002-9.jpg",
    "http://wcfresource.a1edu.com/newsystem/image/br/eb/2a-002/eb-2a-002-10.jpg",
    "http://wcfresource.a1edu.com/newsystem/image/br/eb/2a-002/eb-2a-002-11.jpg",
    "http://wcfresource.a1edu.com/newsystem/image/br/eb/2a-002/eb-2a-002-12.jpg",
    "http://wcfresource.a1edu.com/newsystem/image/br/eb/2a-002/eb-2a-002-13.jpg",
    "http://wcfresource.a1edu.com/newsystem/image/br/eb/2a-002/eb-2a-002-14.jpg",
  ];
  ...
  eBookPageImg.onload = () => {
    ...
    _pagesMaxWidth(windowHeight);
    _pagesScale(pagesMaxWidth / pageHeight);
  };
  const [pageWidth, _pageWidth] = useState();
  const [pageHeight, _pageHeight] = useState();
  const [pagesMaxWidth, _pagesMaxWidth] = useState();
  ...
  return (
    ...
    >
      ...
      <div id="ebook" style={{ maxWidth: pagesMaxWidth }}>
                ...
                {pageNumber == 1 ? null : (
                  <div
                    ...
                    style={{
                      width: pageWidth * pagesScale,
                      height: pageHeight * pagesScale,
                      backgroundImage: `url("http://wcfresource.a1edu.com/newsystem/image/br/eb/2a-002/eb-2a-002-${pageNumber}.jpg")`,
                    }}
                  >
                    <div
                      style={{
